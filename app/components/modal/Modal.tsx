  ...
  return (
    <>
      ...
      bg-neutral-800/70">
        ...
        >
            <div className="translate h-full lg:h-auto md:h-auto border-0 rounded-lg shadown-lg relative flex flex-col w-full bg-white outline-none focus:outline-none">
                {/* HEADER */}
